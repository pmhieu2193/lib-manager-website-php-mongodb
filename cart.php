...
<body>
    ...
    <?php if(isset($_SESSION["max"])&&$count>0&&$_SESSION["trang_thai_tai_khoan"]!=0){
        echo'
            <a>Sau khi bấm yêu cầu mượn, vui lòng đem sách đến thủ thư xác nhận trong vòng 2 giờ, 2h xử lý ở trang xác nhận ycm</a><br>
            <a>Nếu số lượng sách hết mà sách vẫn trong giở thì sẽ phải xử lý chặn mượn</a>';
        $today= new DateTime;
        echo '
        <table>
            <tr>
