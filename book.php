                    ...
                    if($book->so_luong>0){
                        ...
                        if(isset ($_SESSION['ma_rank'])){
                            ...
                            if($ma_rank!=-1&&isset($_SESSION['_id'])){
                                ...
                                echo '<form action="action_wishlist.php" type="post"><input name="id_book" type="hidden" value="'.$book->_id.'"><button type="submit" name="wishlist_action" class="btn cart-btn">Danh sách yêu thích &#x2764;</button></form></div>';
                            }
                            else{
